...
const PROJECT_SUBJECT = "Real Estate Operations Evidence Review Simple RAG - Beginner Custom 6";
const DOMAIN_SUMMARY = "The system will review real estate operations evidence, categorizing it as Red (critical issues), Amber (potential issues), or Green (no issues).";
const USER_PERSONA = "Real Estate Operations Manager: Responsible for overseeing real estate operations and ensuring compliance with regulations.";
const STARTER_QUESTIONS = ["What is the purpose of the system?", "What are the key features of the system?", "How will the system be deployed?"];
